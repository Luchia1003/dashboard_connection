  ...
  try {
    ...
    const rows = await new Promise((resolve, reject) => {
      conn.execute({
        ...
        sqlText: `
          SELECT * FROM SKU_PROFIT_PROJECT.DASHBOARD_DB.DAILY_SKU_COUPON_PROFIT
          WHERE RUN_DATE = (SELECT MAX(RUN_DATE) FROM SKU_PROFIT_PROJECT.DASHBOARD_DB.DAILY_SKU_COUPON_PROFIT)
